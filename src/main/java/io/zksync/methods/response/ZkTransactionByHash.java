...
public class ZkTransactionByHash extends Transaction {

    private String l1BatchNumber;
    private String l1BatchTxIndex;

    public ZkTransactionByHash(String hash,
                               String nonce,
                               String blockHash,
                               String blockNumber,
                               String chainId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ZkTransactionByHash)) return false;
        if (!super.equals(o)) return false;
        ZkTransactionByHash that = (ZkTransactionByHash) o;
