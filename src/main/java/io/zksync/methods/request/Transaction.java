...
public class Transaction {
  ...
  public static Transaction createEtherTransaction(
      String from, BigInteger gasPrice, BigInteger gasLimit, String to, BigInteger value) {
  ...
  public static Transaction create2ContractTransaction(
      String from, BigInteger gasPrice, BigInteger gasLimit, BigInteger value, String bytecode) {
    ...
    Eip712Meta meta =
        new Eip712Meta(BigInteger.valueOf(160000L), null, new byte[][] {bytecodeBytes}, null);
    return new Transaction(
        from, ZkSyncAddresses.CONTRACT_DEPLOYER_ADDRESS, gasPrice, gasLimit, value, calldata, meta);
  }

  public static Transaction create2ContractTransaction(
      String from, BigInteger gasPrice, BigInteger gasLimit, String bytecode) {
    byte[] bytecodeBytes = Numeric.hexStringToByteArray(bytecode);
    String calldata = FunctionEncoder.encode(ContractDeployer.encodeCreate2(bytecodeBytes));
    Eip712Meta meta =
        new Eip712Meta(BigInteger.valueOf(160000L), null, new byte[][] {bytecodeBytes}, null);
    return new Transaction(
        from, ZkSyncAddresses.CONTRACT_DEPLOYER_ADDRESS, gasPrice, gasLimit, null, calldata, meta);
  }

  public static Transaction create2ContractTransaction(
      String from, BigInteger gasPrice, BigInteger gasLimit, String bytecode, String calldata) {
    byte[] bytecodeBytes = Numeric.hexStringToByteArray(bytecode);
    byte[] calldataBytes = Numeric.hexStringToByteArray(calldata);
    String calldataCreate =
        FunctionEncoder.encode(ContractDeployer.encodeCreate2(bytecodeBytes, calldataBytes));
    Eip712Meta meta =
        new Eip712Meta(BigInteger.valueOf(160000L), null, new byte[][] {bytecodeBytes}, null);
    return new Transaction(
        from,
  ...
  public static Transaction create2ContractTransaction(
    ...
    byte[] calldataBytes = Numeric.hexStringToByteArray(calldata);
    String calldataCreate =
        FunctionEncoder.encode(ContractDeployer.encodeCreate2(bytecodeBytes, calldataBytes, salt));
    Eip712Meta meta =
        new Eip712Meta(BigInteger.valueOf(160000L), null, new byte[][] {bytecodeBytes}, null);
    return new Transaction(
        from,
  ...
  public static Transaction create2ContractTransaction(
    ...
    Eip712Meta meta =
        new Eip712Meta(
            BigInteger.valueOf(160000L), customSignatureBytes, new byte[][] {bytecodeBytes}, null);
    return new Transaction(
        from,
        ZkSyncAddresses.CONTRACT_DEPLOYER_ADDRESS,
        gasPrice,
  ...
  public static Transaction create2AccountTransaction(
    ...
    byte[] calldataBytes = Numeric.hexStringToByteArray(calldata);
    String calldataCreate =
        FunctionEncoder.encode(ContractDeployer.encodeCreate2Account(bytecodeBytes, calldataBytes));
    Eip712Meta meta =
        new Eip712Meta(BigInteger.valueOf(160000L), null, new byte[][] {bytecodeBytes}, null);
    return new Transaction(
        from,
    ...
    String calldataCreate =
        FunctionEncoder.encode(
            ContractDeployer.encodeCreate2Account(
                bytecodeBytes, calldataBytes, salt, AccountAbstractionVersion.Version1));
    Eip712Meta meta =
        new Eip712Meta(BigInteger.valueOf(160000L), null, new byte[][] {bytecodeBytes}, null);
    return new Transaction(
        from,
  ...
  public static Transaction createContractTransaction(
    ...
    byte[] calldataBytes = Numeric.hexStringToByteArray(calldata);
    String calldataCreate =
        FunctionEncoder.encode(ContractDeployer.encodeCreate(bytecodeBytes, calldataBytes));
    Eip712Meta meta =
        new Eip712Meta(BigInteger.valueOf(160000L), null, new byte[][] {bytecodeBytes}, null);
    return new Transaction(
        from,
  ...
  public static Transaction createFunctionCallTransaction(
      String from, String to, BigInteger gasPrice, BigInteger gasLimit, String data) {
  ...
  public static Transaction createFunctionCallTransaction(
    ...
    Eip712Meta meta =
        new Eip712Meta(
            BigInteger.valueOf(160000L),
            Numeric.hexStringToByteArray(customSignature),
            null,
            paymasterParams);
    return new Transaction(from, to, gasPrice, gasLimit, value, data, meta);
  }
