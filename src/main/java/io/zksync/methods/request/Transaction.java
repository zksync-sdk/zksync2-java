...
public class Transaction {
    ...
    public static Transaction create2ContractTransaction(
        ...
        Eip712Meta meta = new Eip712Meta(BigInteger.ZERO, null, new byte[][] {bytecodeBytes}, new PaymasterParams());
    ...
    public static Transaction createFunctionCallTransaction(
        ...
        Eip712Meta meta = new Eip712Meta(BigInteger.ZERO, null, null, new PaymasterParams());
