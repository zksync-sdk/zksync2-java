...
public class Fee {
  ...
  @JsonIgnore private Uint256 gasLimit;

  @JsonIgnore private Uint256 maxFeePerGas;

  @JsonIgnore private Uint256 maxPriorityFeePerGas;

  @JsonIgnore private Uint256 gasPerPubdataLimit;
