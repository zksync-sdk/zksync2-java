...
public class ZkSyncTransactionManager extends TransactionManager {
  ...
  public ZkSyncTransactionManager(
      ZkSync zkSync, EthSigner signer, ZkTransactionFeeProvider feeProvider) {
    super(
  ...
  public EthSendTransaction sendTransaction(
      ...
      if (gasLimit == null) {
        Transaction estimate =
            Transaction.createFunctionCallTransaction(
                getFromAddress(), to, BigInteger.ZERO, BigInteger.ZERO, data);
    ...
    String signature =
        getSigner()
            .getDomain()
            .thenCompose(domain -> getSigner().signTypedData(domain, transaction))
            .join();
    byte[] signed =
  ...
  protected BigInteger getNonce() throws IOException {
    EthGetTransactionCount ethGetTransactionCount =
        zkSync
            .ethGetTransactionCount(getSigner().getAddress(), ZkBlockParameterName.COMMITTED)
            .send();
