...
public class Transfer extends Transaction {
    ...
    public Transfer(Address token, Address to, Uint256 amount, Address initiatorAddress, Address feeToken, Uint256 fee, Uint32 nonce, TimeRange validIn) {
    ...
    public Transfer(String token, String to, BigInteger amount, String initiatorAddress, String feeToken, BigInteger fee, Integer nonce, TimeRange validIn) {
        this(
            new Address(token),
            new Address(to),
            new Uint256(amount),
