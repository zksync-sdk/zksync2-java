...
public class JsonRpc2_0ZkSync extends JsonRpc2_0Web3j implements ZkSync {
  ...
  public Request<?, ZksEstimateFee> zksEstimateFee(Transaction transaction) {
    return new Request<>(
        ...
        web3jService,
        ZksEstimateFee.class);
  }

  @Override
  public Request<?, ZksMainContract> zksMainContract() {
    return new Request<>(
        "zks_getMainContract", Collections.emptyList(), web3jService, ZksMainContract.class);
  }
  ...
  public Request<?, ZksTokenPrice> zksGetTokenPrice(String tokenAddress) {
    return new Request<>(
        "zks_getTokenPrice",
        Collections.singletonList(tokenAddress),
        web3jService,
        ZksTokenPrice.class);
  }
  ...
  public Request<?, ZksL1ChainId> zksL1ChainId() {
    return new Request<>(
        "zks_L1ChainId", Collections.emptyList(), web3jService, ZksL1ChainId.class);
  }
  ...
  public Request<?, ZksContractDebugInfo> zksGetContractDebugInfo(String contractAddress) {
    return new Request<>(
        ...
        Collections.singletonList(contractAddress),
        web3jService,
        ZksContractDebugInfo.class);
  }
  ...
  public Request<?, ZksAccountBalances> zksGetAllAccountBalances(String address) {
    return new Request<>(
        ...
        web3jService,
        ZksAccountBalances.class);
  }

  @Override
  public Request<?, ZksBridgeAddresses> zksGetBridgeContracts() {
    return new Request<>(
        "zks_getBridgeContracts", Collections.emptyList(), web3jService, ZksBridgeAddresses.class);
  }

  @Override
  public Request<?, ZksMessageProof> zksGetL2ToL1MsgProof(
      Integer block, String sender, String message, @Nullable Long l2LogPosition) {
    return new Request<>(
        "zks_getL2ToL1MsgProof",
        Arrays.asList(block, sender, message),
        web3jService,
        ZksMessageProof.class);
  }

  @Override
  public Request<?, ZksMessageProof> zksGetL2ToL1LogProof(String txHash, int index) {
    return new Request<>(
        "zks_getL2ToL1LogProof", Arrays.asList(txHash, index), web3jService, ZksMessageProof.class);
  }
  ...
  public Request<?, ZksTestnetPaymasterAddress> zksGetTestnetPaymaster() {
    return new Request<>(
        ...
        web3jService,
        ZksTestnetPaymasterAddress.class);
  }
  ...
  public Request<?, ZksGetTransactionReceipt> zksGetTransactionReceipt(String transactionHash) {
    return new Request<>(
        ...
        Collections.singletonList(transactionHash),
        web3jService,
        ZksGetTransactionReceipt.class);
  }
  ...
  public Request<?, ZksGetTransactionDetails> zksGetTransactionDetails(String transactionHash) {
    return new Request<>(
        ...
        Collections.singletonList(transactionHash),
        web3jService,
        ZksGetTransactionDetails.class);
  }
