...
public class IL2Bridge extends Contract {
  ...
  public RemoteFunctionCall<TransactionReceipt> finalizeDeposit(
      String _l1Sender, String _l2Receiver, String _l1Token, BigInteger _amount, byte[] _data) {
    final Function function =
        new Function(
            FUNC_FINALIZEDEPOSIT,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.Address(_l1Sender),
  ...
  public RemoteFunctionCall<TransactionReceipt> initialize(
      String _l1Bridge, byte[] _l2TokenProxyBytecodeHash, String _governor) {
    final Function function =
        new Function(
            FUNC_INITIALIZE,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.Address(_l1Bridge),
  ...
  public RemoteFunctionCall<TransactionReceipt> withdraw(
      String _l1Receiver, String _l2Token, BigInteger _amount) {
    final Function function =
        new Function(
            FUNC_WITHDRAW,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.Address(_l1Receiver),
  ...
  public static RemoteCall<IL2Bridge> deploy(
  ...
  public static RemoteCall<IL2Bridge> deploy(
    ...
    return deployRemoteCall(
        IL2Bridge.class, web3j, transactionManager, contractGasProvider, BINARY, "");
  }
  ...
  public static RemoteCall<IL2Bridge> deploy(
      ...
      BigInteger gasLimit) {
    return deployRemoteCall(
        IL2Bridge.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
  }
