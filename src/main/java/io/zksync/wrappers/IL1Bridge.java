...
public class IL1Bridge extends Contract {
  ...
  public static final Event CLAIMEDFAILEDDEPOSIT_EVENT =
      new Event(
  ...
  public static final Event DEPOSITINITIATED_EVENT =
      new Event(
          "DepositInitiated",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Address>(true) {},
  ...
  public static final Event WITHDRAWALFINALIZED_EVENT =
      new Event(
          "WithdrawalFinalized",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Address>(true) {},
  ...
  public static List<ClaimedFailedDepositEventResponse> getClaimedFailedDepositEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(CLAIMEDFAILEDDEPOSIT_EVENT, transactionReceipt);
    ArrayList<ClaimedFailedDepositEventResponse> responses =
        new ArrayList<ClaimedFailedDepositEventResponse>(valueList.size());
  ...
  public Flowable<ClaimedFailedDepositEventResponse> claimedFailedDepositEventFlowable(
      EthFilter filter) {
    return web3j
        .ethLogFlowable(filter)
        .map(
            new Function<Log, ClaimedFailedDepositEventResponse>() {
              @Override
              public ClaimedFailedDepositEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues =
                    extractEventParametersWithLog(CLAIMEDFAILEDDEPOSIT_EVENT, log);
                ClaimedFailedDepositEventResponse typedResponse =
                    new ClaimedFailedDepositEventResponse();
  ...
  public static List<DepositInitiatedEventResponse> getDepositInitiatedEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(DEPOSITINITIATED_EVENT, transactionReceipt);
    ArrayList<DepositInitiatedEventResponse> responses =
        new ArrayList<DepositInitiatedEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public Flowable<DepositInitiatedEventResponse> depositInitiatedEventFlowable(EthFilter filter) {
    return web3j
        .ethLogFlowable(filter)
        .map(
            new Function<Log, DepositInitiatedEventResponse>() {
              @Override
              public DepositInitiatedEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues =
                    extractEventParametersWithLog(DEPOSITINITIATED_EVENT, log);
                DepositInitiatedEventResponse typedResponse = new DepositInitiatedEventResponse();
                typedResponse.log = log;
                typedResponse.from = (String) eventValues.getIndexedValues().get(0).getValue();
                typedResponse.to = (String) eventValues.getIndexedValues().get(1).getValue();
  ...
  public Flowable<DepositInitiatedEventResponse> depositInitiatedEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<WithdrawalFinalizedEventResponse> getWithdrawalFinalizedEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(WITHDRAWALFINALIZED_EVENT, transactionReceipt);
    ArrayList<WithdrawalFinalizedEventResponse> responses =
        new ArrayList<WithdrawalFinalizedEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public Flowable<WithdrawalFinalizedEventResponse> withdrawalFinalizedEventFlowable(
      EthFilter filter) {
    return web3j
        .ethLogFlowable(filter)
        .map(
            new Function<Log, WithdrawalFinalizedEventResponse>() {
              @Override
              public WithdrawalFinalizedEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues =
                    extractEventParametersWithLog(WITHDRAWALFINALIZED_EVENT, log);
                WithdrawalFinalizedEventResponse typedResponse =
                    new WithdrawalFinalizedEventResponse();
                typedResponse.log = log;
                typedResponse.to = (String) eventValues.getIndexedValues().get(0).getValue();
                typedResponse.l1Token = (String) eventValues.getIndexedValues().get(1).getValue();
                typedResponse.amount =
  ...
  public RemoteFunctionCall<TransactionReceipt> claimFailedDeposit(
    ...
    final org.web3j.abi.datatypes.Function function =
        new org.web3j.abi.datatypes.Function(
            ...
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.Address(_depositSender),
  ...
  public RemoteFunctionCall<TransactionReceipt> deposit(
      ...
      String _l1Token,
      BigInteger _amount,
      BigInteger _l2TxGasLimit,
      BigInteger _l2TxGasPerPubdataByte,
      BigInteger weiValue) {
    final org.web3j.abi.datatypes.Function function =
        new org.web3j.abi.datatypes.Function(
            FUNC_DEPOSIT,
  ...
  public RemoteFunctionCall<TransactionReceipt> finalizeWithdrawal(
      BigInteger _l2BlockNumber,
      BigInteger _l2MessageIndex,
      BigInteger _l2TxNumberInBlock,
      byte[] _message,
  ...
  public RemoteFunctionCall<Boolean> isWithdrawalFinalized(
      BigInteger _l2BlockNumber, BigInteger _l2MessageIndex) {
    final org.web3j.abi.datatypes.Function function =
        new org.web3j.abi.datatypes.Function(
            FUNC_ISWITHDRAWALFINALIZED,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.generated.Uint256(_l2BlockNumber),
                new org.web3j.abi.datatypes.generated.Uint256(_l2MessageIndex)),
  ...
  public static RemoteCall<IL1Bridge> deploy(
  ...
  public static RemoteCall<IL1Bridge> deploy(
    ...
    return deployRemoteCall(
        IL1Bridge.class, web3j, transactionManager, contractGasProvider, BINARY, "");
  }
  ...
  public static RemoteCall<IL1Bridge> deploy(
      ...
      BigInteger gasLimit) {
    return deployRemoteCall(
        IL1Bridge.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
  }
