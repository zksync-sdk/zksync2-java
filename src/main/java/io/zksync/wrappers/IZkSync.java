...
//        typedResponse.txId = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
    ...
    public String encodeRequestL2Transaction(String _contractL2, BigInteger _l2Value, byte[] _calldata, BigInteger _l2GasLimit, BigInteger _l2GasPerPubdataByteLimit, List<byte[]> _factoryDeps, String _refundRecipient, BigInteger weiValue) {
        final Function function = new Function(
