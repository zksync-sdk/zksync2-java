...
public class L1Messenger extends Contract {
  ...
  public static final Event L1MESSAGESENT_EVENT =
      new Event(
          "L1MessageSent",
  ...
  public static List<L1MessageSentEventResponse> getL1MessageSentEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(L1MESSAGESENT_EVENT, transactionReceipt);
    ArrayList<L1MessageSentEventResponse> responses =
        new ArrayList<L1MessageSentEventResponse>(valueList.size());
  ...
  public Flowable<L1MessageSentEventResponse> l1MessageSentEventFlowable(EthFilter filter) {
    return web3j
        ...
        .map(
            new Function<Log, L1MessageSentEventResponse>() {
              @Override
              public L1MessageSentEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues =
                    extractEventParametersWithLog(L1MESSAGESENT_EVENT, log);
                L1MessageSentEventResponse typedResponse = new L1MessageSentEventResponse();
  ...
  public Flowable<L1MessageSentEventResponse> l1MessageSentEventFlowable(
  ...
  @Deprecated
  public static L1Messenger load(
      String contractAddress,
      Web3j web3j,
      Credentials credentials,
      BigInteger gasPrice,
