...
public class ZkSyncContract extends Contract {
  ...
  public static final String FUNC_GETL2DEFAULTACCOUNTBYTECODEHASH =
  ...
  public static final String FUNC_SETL2DEFAULTACCOUNTBYTECODEHASH =
  ...
  public static final Event BLOCKCOMMIT_EVENT =
      new Event(
          "BlockCommit",
  ...
  public static final Event BLOCKEXECUTION_EVENT =
      new Event(
          "BlockExecution",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Uint256>(true) {},
  ...
  public static final Event BLOCKSREVERT_EVENT =
      new Event(
          "BlocksRevert",
          Arrays.<TypeReference<?>>asList(
  ...
  public static final Event BLOCKSVERIFICATION_EVENT =
      new Event(
          "BlocksVerification",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Uint256>(true) {}, new TypeReference<Uint256>(true) {}));
  ;

  public static final Event CANCELUPGRADEPROPOSAL_EVENT =
      new Event(
          "CancelUpgradeProposal",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Uint256>(true) {}, new TypeReference<Bytes32>(true) {}));
  ;

  public static final Event ETHWITHDRAWALFINALIZED_EVENT =
      new Event(
  ...
  public static final Event EXECUTEUPGRADE_EVENT =
      new Event(
          "ExecuteUpgrade",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Uint256>(true) {},
  ...
  public static final Event FREEZE_EVENT = new Event("Freeze", Arrays.<TypeReference<?>>asList());
  ;

  public static final Event ISPORTERAVAILABLESTATUSUPDATE_EVENT =
      new Event(
          "IsPorterAvailableStatusUpdate",
          Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
  ;

  public static final Event NEWGOVERNOR_EVENT =
      new Event(
          "NewGovernor",
          Arrays.<TypeReference<?>>asList(
  ...
  public static final Event NEWL2BOOTLOADERBYTECODEHASH_EVENT =
      new Event(
  ...
  public static final Event NEWL2DEFAULTACCOUNTBYTECODEHASH_EVENT =
      new Event(
  ...
  public static final Event NEWPENDINGGOVERNOR_EVENT =
      new Event(
          "NewPendingGovernor",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}));
  ...
  public static final Event NEWPRIORITYREQUEST_EVENT =
      new Event(
          "NewPriorityRequest",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Uint256>() {},
              ...
              new TypeReference<L2CanonicalTransaction>() {},
              new TypeReference<DynamicArray<DynamicBytes>>() {}));
  ;

  public static final Event NEWPRIORITYTXMAXGASLIMIT_EVENT =
      new Event(
  ...
  public static final Event NEWVERIFIER_EVENT =
      new Event(
          "NewVerifier",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}));
  ...
  public static final Event NEWVERIFIERPARAMS_EVENT =
      new Event(
          "NewVerifierParams",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<VerifierParams>() {}, new TypeReference<VerifierParams>() {}));
  ;

  public static final Event PROPOSESHADOWUPGRADE_EVENT =
      new Event(
  ...
  public static final Event PROPOSETRANSPARENTUPGRADE_EVENT =
      new Event(
          "ProposeTransparentUpgrade",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<DiamondCutData>() {},
              new TypeReference<Uint256>(true) {},
              new TypeReference<Bytes32>() {}));
  ;

  public static final Event SECURITYCOUNCILUPGRADEAPPROVE_EVENT =
      new Event(
  ...
  public static final Event UNFREEZE_EVENT =
      new Event("Unfreeze", Arrays.<TypeReference<?>>asList());
  ;

  public static final Event VALIDATORSTATUSUPDATE_EVENT =
      new Event(
  ...
  public static List<BlockCommitEventResponse> getBlockCommitEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(BLOCKCOMMIT_EVENT, transactionReceipt);
    ArrayList<BlockCommitEventResponse> responses =
        new ArrayList<BlockCommitEventResponse>(valueList.size());
  ...
  public static BlockCommitEventResponse getBlockCommitEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(BLOCKCOMMIT_EVENT, log);
    BlockCommitEventResponse typedResponse = new BlockCommitEventResponse();
  ...
  public Flowable<BlockCommitEventResponse> blockCommitEventFlowable(
  ...
  public static List<BlockExecutionEventResponse> getBlockExecutionEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(BLOCKEXECUTION_EVENT, transactionReceipt);
    ArrayList<BlockExecutionEventResponse> responses =
        new ArrayList<BlockExecutionEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static BlockExecutionEventResponse getBlockExecutionEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(BLOCKEXECUTION_EVENT, log);
    BlockExecutionEventResponse typedResponse = new BlockExecutionEventResponse();
    typedResponse.log = log;
    typedResponse.blockNumber = (BigInteger) eventValues.getIndexedValues().get(0).getValue();
    typedResponse.blockHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
  ...
  public Flowable<BlockExecutionEventResponse> blockExecutionEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<BlocksRevertEventResponse> getBlocksRevertEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(BLOCKSREVERT_EVENT, transactionReceipt);
    ArrayList<BlocksRevertEventResponse> responses =
        new ArrayList<BlocksRevertEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      BlocksRevertEventResponse typedResponse = new BlocksRevertEventResponse();
      typedResponse.log = eventValues.getLog();
      typedResponse.totalBlocksCommitted =
          (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
      typedResponse.totalBlocksVerified =
          (BigInteger) eventValues.getNonIndexedValues().get(1).getValue();
      typedResponse.totalBlocksExecuted =
  ...
  public static BlocksRevertEventResponse getBlocksRevertEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(BLOCKSREVERT_EVENT, log);
    BlocksRevertEventResponse typedResponse = new BlocksRevertEventResponse();
    typedResponse.log = log;
    typedResponse.totalBlocksCommitted =
        (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
  ...
  public Flowable<BlocksRevertEventResponse> blocksRevertEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<BlocksVerificationEventResponse> getBlocksVerificationEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(BLOCKSVERIFICATION_EVENT, transactionReceipt);
    ArrayList<BlocksVerificationEventResponse> responses =
        new ArrayList<BlocksVerificationEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      BlocksVerificationEventResponse typedResponse = new BlocksVerificationEventResponse();
      typedResponse.log = eventValues.getLog();
      typedResponse.previousLastVerifiedBlock =
          (BigInteger) eventValues.getIndexedValues().get(0).getValue();
      typedResponse.currentLastVerifiedBlock =
  ...
  public static BlocksVerificationEventResponse getBlocksVerificationEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(BLOCKSVERIFICATION_EVENT, log);
    BlocksVerificationEventResponse typedResponse = new BlocksVerificationEventResponse();
    typedResponse.log = log;
    typedResponse.previousLastVerifiedBlock =
        (BigInteger) eventValues.getIndexedValues().get(0).getValue();
  ...
  public Flowable<BlocksVerificationEventResponse> blocksVerificationEventFlowable(
      EthFilter filter) {
  ...
  public static List<CancelUpgradeProposalEventResponse> getCancelUpgradeProposalEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(CANCELUPGRADEPROPOSAL_EVENT, transactionReceipt);
    ArrayList<CancelUpgradeProposalEventResponse> responses =
        new ArrayList<CancelUpgradeProposalEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static CancelUpgradeProposalEventResponse getCancelUpgradeProposalEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(CANCELUPGRADEPROPOSAL_EVENT, log);
    CancelUpgradeProposalEventResponse typedResponse = new CancelUpgradeProposalEventResponse();
    typedResponse.log = log;
    typedResponse.proposalId = (BigInteger) eventValues.getIndexedValues().get(0).getValue();
    typedResponse.proposalHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
  ...
  public Flowable<CancelUpgradeProposalEventResponse> cancelUpgradeProposalEventFlowable(
      EthFilter filter) {
  ...
  public static List<EthWithdrawalFinalizedEventResponse> getEthWithdrawalFinalizedEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(ETHWITHDRAWALFINALIZED_EVENT, transactionReceipt);
    ArrayList<EthWithdrawalFinalizedEventResponse> responses =
        new ArrayList<EthWithdrawalFinalizedEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static EthWithdrawalFinalizedEventResponse getEthWithdrawalFinalizedEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(ETHWITHDRAWALFINALIZED_EVENT, log);
    EthWithdrawalFinalizedEventResponse typedResponse = new EthWithdrawalFinalizedEventResponse();
    typedResponse.log = log;
    typedResponse.to = (String) eventValues.getIndexedValues().get(0).getValue();
    typedResponse.amount = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
  ...
  public Flowable<EthWithdrawalFinalizedEventResponse> ethWithdrawalFinalizedEventFlowable(
      EthFilter filter) {
  ...
  public static List<ExecuteUpgradeEventResponse> getExecuteUpgradeEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(EXECUTEUPGRADE_EVENT, transactionReceipt);
    ArrayList<ExecuteUpgradeEventResponse> responses =
        new ArrayList<ExecuteUpgradeEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static ExecuteUpgradeEventResponse getExecuteUpgradeEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(EXECUTEUPGRADE_EVENT, log);
    ExecuteUpgradeEventResponse typedResponse = new ExecuteUpgradeEventResponse();
    typedResponse.log = log;
    typedResponse.proposalId = (BigInteger) eventValues.getIndexedValues().get(0).getValue();
    typedResponse.proposalHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
  ...
  public Flowable<ExecuteUpgradeEventResponse> executeUpgradeEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<FreezeEventResponse> getFreezeEvents(TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(FREEZE_EVENT, transactionReceipt);
  ...
  public Flowable<FreezeEventResponse> freezeEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<IsPorterAvailableStatusUpdateEventResponse>
      getIsPorterAvailableStatusUpdateEvents(TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(
            ISPORTERAVAILABLESTATUSUPDATE_EVENT, transactionReceipt);
    ArrayList<IsPorterAvailableStatusUpdateEventResponse> responses =
        new ArrayList<IsPorterAvailableStatusUpdateEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      IsPorterAvailableStatusUpdateEventResponse typedResponse =
          new IsPorterAvailableStatusUpdateEventResponse();
      typedResponse.log = eventValues.getLog();
      typedResponse.isPorterAvailable =
  ...
  public static IsPorterAvailableStatusUpdateEventResponse
      getIsPorterAvailableStatusUpdateEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(ISPORTERAVAILABLESTATUSUPDATE_EVENT, log);
    IsPorterAvailableStatusUpdateEventResponse typedResponse =
        new IsPorterAvailableStatusUpdateEventResponse();
    typedResponse.log = log;
  ...
  public Flowable<IsPorterAvailableStatusUpdateEventResponse>
      isPorterAvailableStatusUpdateEventFlowable(EthFilter filter) {
    return web3j
        .ethLogFlowable(filter)
        .map(log -> getIsPorterAvailableStatusUpdateEventFromLog(log));
  }

  public Flowable<IsPorterAvailableStatusUpdateEventResponse>
      isPorterAvailableStatusUpdateEventFlowable(
          DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<NewGovernorEventResponse> getNewGovernorEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(NEWGOVERNOR_EVENT, transactionReceipt);
    ArrayList<NewGovernorEventResponse> responses =
        new ArrayList<NewGovernorEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static NewGovernorEventResponse getNewGovernorEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(NEWGOVERNOR_EVENT, log);
    NewGovernorEventResponse typedResponse = new NewGovernorEventResponse();
    typedResponse.log = log;
    typedResponse.oldGovernor = (String) eventValues.getIndexedValues().get(0).getValue();
    typedResponse.newGovernor = (String) eventValues.getIndexedValues().get(1).getValue();
  ...
  public Flowable<NewGovernorEventResponse> newGovernorEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<NewL2BootloaderBytecodeHashEventResponse> getNewL2BootloaderBytecodeHashEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(NEWL2BOOTLOADERBYTECODEHASH_EVENT, transactionReceipt);
    ArrayList<NewL2BootloaderBytecodeHashEventResponse> responses =
        new ArrayList<NewL2BootloaderBytecodeHashEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      NewL2BootloaderBytecodeHashEventResponse typedResponse =
          new NewL2BootloaderBytecodeHashEventResponse();
      typedResponse.log = eventValues.getLog();
      typedResponse.previousBytecodeHash =
  ...
  public static NewL2BootloaderBytecodeHashEventResponse getNewL2BootloaderBytecodeHashEventFromLog(
      Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(NEWL2BOOTLOADERBYTECODEHASH_EVENT, log);
    NewL2BootloaderBytecodeHashEventResponse typedResponse =
        new NewL2BootloaderBytecodeHashEventResponse();
    typedResponse.log = log;
  ...
  public Flowable<NewL2BootloaderBytecodeHashEventResponse>
      newL2BootloaderBytecodeHashEventFlowable(EthFilter filter) {
    return web3j.ethLogFlowable(filter).map(log -> getNewL2BootloaderBytecodeHashEventFromLog(log));
  }

  public Flowable<NewL2BootloaderBytecodeHashEventResponse>
      newL2BootloaderBytecodeHashEventFlowable(
          DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<NewL2DefaultAccountBytecodeHashEventResponse>
      getNewL2DefaultAccountBytecodeHashEvents(TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(
            NEWL2DEFAULTACCOUNTBYTECODEHASH_EVENT, transactionReceipt);
    ArrayList<NewL2DefaultAccountBytecodeHashEventResponse> responses =
        new ArrayList<NewL2DefaultAccountBytecodeHashEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      NewL2DefaultAccountBytecodeHashEventResponse typedResponse =
          new NewL2DefaultAccountBytecodeHashEventResponse();
      typedResponse.log = eventValues.getLog();
      typedResponse.previousBytecodeHash =
          (byte[]) eventValues.getIndexedValues().get(0).getValue();
      typedResponse.newBytecodeHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
  ...
  public static NewL2DefaultAccountBytecodeHashEventResponse
      getNewL2DefaultAccountBytecodeHashEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(NEWL2DEFAULTACCOUNTBYTECODEHASH_EVENT, log);
    NewL2DefaultAccountBytecodeHashEventResponse typedResponse =
        new NewL2DefaultAccountBytecodeHashEventResponse();
    typedResponse.log = log;
    typedResponse.previousBytecodeHash = (byte[]) eventValues.getIndexedValues().get(0).getValue();
  ...
  public Flowable<NewL2DefaultAccountBytecodeHashEventResponse>
      newL2DefaultAccountBytecodeHashEventFlowable(EthFilter filter) {
    return web3j
        .ethLogFlowable(filter)
        .map(log -> getNewL2DefaultAccountBytecodeHashEventFromLog(log));
  }

  public Flowable<NewL2DefaultAccountBytecodeHashEventResponse>
      newL2DefaultAccountBytecodeHashEventFlowable(
          DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<NewPendingGovernorEventResponse> getNewPendingGovernorEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(NEWPENDINGGOVERNOR_EVENT, transactionReceipt);
    ArrayList<NewPendingGovernorEventResponse> responses =
        new ArrayList<NewPendingGovernorEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static NewPendingGovernorEventResponse getNewPendingGovernorEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(NEWPENDINGGOVERNOR_EVENT, log);
    NewPendingGovernorEventResponse typedResponse = new NewPendingGovernorEventResponse();
    typedResponse.log = log;
    typedResponse.oldPendingGovernor = (String) eventValues.getIndexedValues().get(0).getValue();
    typedResponse.newPendingGovernor = (String) eventValues.getIndexedValues().get(1).getValue();
  ...
  public Flowable<NewPendingGovernorEventResponse> newPendingGovernorEventFlowable(
      EthFilter filter) {
  ...
  public static List<NewPriorityRequestEventResponse> getNewPriorityRequestEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(NEWPRIORITYREQUEST_EVENT, transactionReceipt);
    ArrayList<NewPriorityRequestEventResponse> responses =
        new ArrayList<NewPriorityRequestEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      ...
      typedResponse.expirationTimestamp =
          (BigInteger) eventValues.getNonIndexedValues().get(2).getValue();
      typedResponse.transaction = (L2CanonicalTransaction) eventValues.getNonIndexedValues().get(3);
      typedResponse.factoryDeps =
          (List<byte[]>) ((Array) eventValues.getNonIndexedValues().get(4)).getNativeValueCopy();
      responses.add(typedResponse);
    }
    return responses;
  }
  ...
  public static NewPriorityRequestEventResponse getNewPriorityRequestEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(NEWPRIORITYREQUEST_EVENT, log);
    NewPriorityRequestEventResponse typedResponse = new NewPriorityRequestEventResponse();
    typedResponse.log = log;
    typedResponse.txId = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
    typedResponse.txHash = (byte[]) eventValues.getNonIndexedValues().get(1).getValue();
  ...
  public Flowable<NewPriorityRequestEventResponse> newPriorityRequestEventFlowable(
      EthFilter filter) {
  ...
  public static List<NewPriorityTxMaxGasLimitEventResponse> getNewPriorityTxMaxGasLimitEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(NEWPRIORITYTXMAXGASLIMIT_EVENT, transactionReceipt);
    ArrayList<NewPriorityTxMaxGasLimitEventResponse> responses =
        new ArrayList<NewPriorityTxMaxGasLimitEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      NewPriorityTxMaxGasLimitEventResponse typedResponse =
          new NewPriorityTxMaxGasLimitEventResponse();
      typedResponse.log = eventValues.getLog();
      typedResponse.oldPriorityTxMaxGasLimit =
          (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
      typedResponse.newPriorityTxMaxGasLimit =
          (BigInteger) eventValues.getNonIndexedValues().get(1).getValue();
      responses.add(typedResponse);
    }
    return responses;
  ...
  public static NewPriorityTxMaxGasLimitEventResponse getNewPriorityTxMaxGasLimitEventFromLog(
      Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(NEWPRIORITYTXMAXGASLIMIT_EVENT, log);
    NewPriorityTxMaxGasLimitEventResponse typedResponse =
        new NewPriorityTxMaxGasLimitEventResponse();
    typedResponse.log = log;
    typedResponse.oldPriorityTxMaxGasLimit =
  ...
  public Flowable<NewPriorityTxMaxGasLimitEventResponse> newPriorityTxMaxGasLimitEventFlowable(
      EthFilter filter) {
  ...
  public static List<NewVerifierEventResponse> getNewVerifierEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(NEWVERIFIER_EVENT, transactionReceipt);
    ArrayList<NewVerifierEventResponse> responses =
        new ArrayList<NewVerifierEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static NewVerifierEventResponse getNewVerifierEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(NEWVERIFIER_EVENT, log);
    NewVerifierEventResponse typedResponse = new NewVerifierEventResponse();
    typedResponse.log = log;
    typedResponse.oldVerifier = (String) eventValues.getIndexedValues().get(0).getValue();
    typedResponse.newVerifier = (String) eventValues.getIndexedValues().get(1).getValue();
  ...
  public Flowable<NewVerifierEventResponse> newVerifierEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<NewVerifierParamsEventResponse> getNewVerifierParamsEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(NEWVERIFIERPARAMS_EVENT, transactionReceipt);
    ArrayList<NewVerifierParamsEventResponse> responses =
        new ArrayList<NewVerifierParamsEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static NewVerifierParamsEventResponse getNewVerifierParamsEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(NEWVERIFIERPARAMS_EVENT, log);
    NewVerifierParamsEventResponse typedResponse = new NewVerifierParamsEventResponse();
    typedResponse.log = log;
    typedResponse.oldVerifierParams = (VerifierParams) eventValues.getNonIndexedValues().get(0);
    typedResponse.newVerifierParams = (VerifierParams) eventValues.getNonIndexedValues().get(1);
  ...
  public Flowable<NewVerifierParamsEventResponse> newVerifierParamsEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<ProposeShadowUpgradeEventResponse> getProposeShadowUpgradeEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(PROPOSESHADOWUPGRADE_EVENT, transactionReceipt);
    ArrayList<ProposeShadowUpgradeEventResponse> responses =
        new ArrayList<ProposeShadowUpgradeEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static ProposeShadowUpgradeEventResponse getProposeShadowUpgradeEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(PROPOSESHADOWUPGRADE_EVENT, log);
    ProposeShadowUpgradeEventResponse typedResponse = new ProposeShadowUpgradeEventResponse();
    typedResponse.log = log;
    typedResponse.proposalId = (BigInteger) eventValues.getIndexedValues().get(0).getValue();
    typedResponse.proposalHash = (byte[]) eventValues.getIndexedValues().get(1).getValue();
  ...
  public Flowable<ProposeShadowUpgradeEventResponse> proposeShadowUpgradeEventFlowable(
      EthFilter filter) {
  ...
  public static List<ProposeTransparentUpgradeEventResponse> getProposeTransparentUpgradeEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(PROPOSETRANSPARENTUPGRADE_EVENT, transactionReceipt);
    ArrayList<ProposeTransparentUpgradeEventResponse> responses =
        new ArrayList<ProposeTransparentUpgradeEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      ProposeTransparentUpgradeEventResponse typedResponse =
          new ProposeTransparentUpgradeEventResponse();
      typedResponse.log = eventValues.getLog();
      typedResponse.proposalId = (BigInteger) eventValues.getIndexedValues().get(0).getValue();
  ...
  public static ProposeTransparentUpgradeEventResponse getProposeTransparentUpgradeEventFromLog(
      Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(PROPOSETRANSPARENTUPGRADE_EVENT, log);
    ProposeTransparentUpgradeEventResponse typedResponse =
        new ProposeTransparentUpgradeEventResponse();
    typedResponse.log = log;
    typedResponse.proposalId = (BigInteger) eventValues.getIndexedValues().get(0).getValue();
  ...
  public Flowable<ProposeTransparentUpgradeEventResponse> proposeTransparentUpgradeEventFlowable(
      EthFilter filter) {
  ...
  public static List<SecurityCouncilUpgradeApproveEventResponse>
      getSecurityCouncilUpgradeApproveEvents(TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(
            SECURITYCOUNCILUPGRADEAPPROVE_EVENT, transactionReceipt);
    ArrayList<SecurityCouncilUpgradeApproveEventResponse> responses =
        new ArrayList<SecurityCouncilUpgradeApproveEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      SecurityCouncilUpgradeApproveEventResponse typedResponse =
  ...
  public static SecurityCouncilUpgradeApproveEventResponse
      getSecurityCouncilUpgradeApproveEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(SECURITYCOUNCILUPGRADEAPPROVE_EVENT, log);
    SecurityCouncilUpgradeApproveEventResponse typedResponse =
        new SecurityCouncilUpgradeApproveEventResponse();
    typedResponse.log = log;
    typedResponse.proposalId = (BigInteger) eventValues.getIndexedValues().get(0).getValue();
  ...
  public Flowable<SecurityCouncilUpgradeApproveEventResponse>
      securityCouncilUpgradeApproveEventFlowable(EthFilter filter) {
    return web3j
        .ethLogFlowable(filter)
        .map(log -> getSecurityCouncilUpgradeApproveEventFromLog(log));
  }

  public Flowable<SecurityCouncilUpgradeApproveEventResponse>
      securityCouncilUpgradeApproveEventFlowable(
          DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<UnfreezeEventResponse> getUnfreezeEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(UNFREEZE_EVENT, transactionReceipt);
    ArrayList<UnfreezeEventResponse> responses =
        new ArrayList<UnfreezeEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public Flowable<UnfreezeEventResponse> unfreezeEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
  ...
  public static List<ValidatorStatusUpdateEventResponse> getValidatorStatusUpdateEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        staticExtractEventParametersWithLog(VALIDATORSTATUSUPDATE_EVENT, transactionReceipt);
    ArrayList<ValidatorStatusUpdateEventResponse> responses =
        new ArrayList<ValidatorStatusUpdateEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
  ...
  public static ValidatorStatusUpdateEventResponse getValidatorStatusUpdateEventFromLog(Log log) {
    Contract.EventValuesWithLog eventValues =
        staticExtractEventParametersWithLog(VALIDATORSTATUSUPDATE_EVENT, log);
    ValidatorStatusUpdateEventResponse typedResponse = new ValidatorStatusUpdateEventResponse();
    typedResponse.log = log;
    typedResponse.validatorAddress = (String) eventValues.getIndexedValues().get(0).getValue();
    typedResponse.isActive = (Boolean) eventValues.getNonIndexedValues().get(0).getValue();
  ...
  public Flowable<ValidatorStatusUpdateEventResponse> validatorStatusUpdateEventFlowable(
      EthFilter filter) {
  ...
  public RemoteFunctionCall<TransactionReceipt> acceptGovernor() {
    final Function function =
        new Function(
            FUNC_ACCEPTGOVERNOR, Arrays.<Type>asList(), Collections.<TypeReference<?>>emptyList());
  ...
  public RemoteFunctionCall<TransactionReceipt> cancelUpgradeProposal(byte[] _proposedUpgradeHash) {
    final Function function =
        new Function(
            ...
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.generated.Bytes32(_proposedUpgradeHash)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }

  public RemoteFunctionCall<TransactionReceipt> commitBlocks(
      StoredBlockInfo _lastCommittedBlockData, List<CommitBlockInfo> _newBlocksData) {
    final Function function =
        new Function(
            FUNC_COMMITBLOCKS,
            Arrays.<Type>asList(
                _lastCommittedBlockData,
                new org.web3j.abi.datatypes.DynamicArray<CommitBlockInfo>(
                    CommitBlockInfo.class, _newBlocksData)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }
  ...
  public RemoteFunctionCall<TransactionReceipt> executeBlocks(List<StoredBlockInfo> _blocksData) {
    final Function function =
        new Function(
            FUNC_EXECUTEBLOCKS,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.DynamicArray<StoredBlockInfo>(
                    StoredBlockInfo.class, _blocksData)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }

  public RemoteFunctionCall<TransactionReceipt> executeUpgrade(
      DiamondCutData _diamondCut, byte[] _proposalSalt) {
    final Function function =
        new Function(
            FUNC_EXECUTEUPGRADE,
            Arrays.<Type>asList(
                _diamondCut, new org.web3j.abi.datatypes.generated.Bytes32(_proposalSalt)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }
  ...
  public RemoteFunctionCall<TransactionReceipt> finalizeEthWithdrawal(
      BigInteger _l2BlockNumber,
      BigInteger _l2MessageIndex,
      BigInteger _l2TxNumberInBlock,
      byte[] _message,
      List<byte[]> _merkleProof) {
    final Function function =
        new Function(
            ...
            Arrays.<Type>asList(
                ...
                new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.generated.Bytes32>(
                    ...
                    org.web3j.abi.Utils.typeMap(
                        _merkleProof, org.web3j.abi.datatypes.generated.Bytes32.class))),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }
  ...
  public RemoteFunctionCall<TransactionReceipt> freezeDiamond() {
    final Function function =
        new Function(
            FUNC_FREEZEDIAMOND, Arrays.<Type>asList(), Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }
  ...
  public RemoteFunctionCall<BigInteger> getFirstUnprocessedPriorityTx() {
    final Function function =
        new Function(
            FUNC_GETFIRSTUNPROCESSEDPRIORITYTX,
            Arrays.<Type>asList(),
            Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
    return executeRemoteCallSingleValueReturn(function, BigInteger.class);
  }
  ...
  public RemoteFunctionCall<byte[]> getL2BootloaderBytecodeHash() {
    final Function function =
        new Function(
            FUNC_GETL2BOOTLOADERBYTECODEHASH,
            Arrays.<Type>asList(),
  ...
  public RemoteFunctionCall<byte[]> getL2DefaultAccountBytecodeHash() {
    final Function function =
        new Function(
            FUNC_GETL2DEFAULTACCOUNTBYTECODEHASH,
            Arrays.<Type>asList(),
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}));
    return executeRemoteCallSingleValueReturn(function, byte[].class);
  }
  ...
  public RemoteFunctionCall<Boolean> isApprovedBySecurityCouncil() {
    final Function function =
        new Function(
            FUNC_ISAPPROVEDBYSECURITYCOUNCIL,
            Arrays.<Type>asList(),
            Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
  ...
  public RemoteFunctionCall<Boolean> isDiamondStorageFrozen() {
    final Function function =
        new Function(
            FUNC_ISDIAMONDSTORAGEFROZEN,
            Arrays.<Type>asList(),
            Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
    return executeRemoteCallSingleValueReturn(function, Boolean.class);
  }

  public RemoteFunctionCall<Boolean> isEthWithdrawalFinalized(
      BigInteger _l2BlockNumber, BigInteger _l2MessageIndex) {
    final Function function =
        new Function(
            FUNC_ISETHWITHDRAWALFINALIZED,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.generated.Uint256(_l2BlockNumber),
                new org.web3j.abi.datatypes.generated.Uint256(_l2MessageIndex)),
            Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
  ...
  public RemoteFunctionCall<BigInteger> l2TransactionBaseCost(
      BigInteger _gasPrice, BigInteger _l2GasLimit, BigInteger _l2GasPerPubdataByteLimit) {
    final Function function =
        new Function(
  ...
  public RemoteFunctionCall<PriorityOperation> priorityQueueFrontOperation() {
    final Function function =
        new Function(
            FUNC_PRIORITYQUEUEFRONTOPERATION,
            Arrays.<Type>asList(),
  ...
  public RemoteFunctionCall<TransactionReceipt> proposeShadowUpgrade(
      byte[] _proposalHash, BigInteger _proposalId) {
    final Function function =
        new Function(
            FUNC_PROPOSESHADOWUPGRADE,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.generated.Bytes32(_proposalHash),
                new org.web3j.abi.datatypes.generated.Uint40(_proposalId)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }

  public RemoteFunctionCall<TransactionReceipt> proposeTransparentUpgrade(
      DiamondCutData _diamondCut, BigInteger _proposalId) {
    final Function function =
        new Function(
            FUNC_PROPOSETRANSPARENTUPGRADE,
            Arrays.<Type>asList(
                _diamondCut, new org.web3j.abi.datatypes.generated.Uint40(_proposalId)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }

  public RemoteFunctionCall<TransactionReceipt> proveBlocks(
      StoredBlockInfo _prevBlock, List<StoredBlockInfo> _committedBlocks, ProofInput _proof) {
    final Function function =
        new Function(
            FUNC_PROVEBLOCKS,
            Arrays.<Type>asList(
                _prevBlock,
                new org.web3j.abi.datatypes.DynamicArray<StoredBlockInfo>(
                    StoredBlockInfo.class, _committedBlocks),
                _proof),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }

  public RemoteFunctionCall<Boolean> proveL1ToL2TransactionStatus(
      byte[] _l2TxHash,
      BigInteger _l2BlockNumber,
      BigInteger _l2MessageIndex,
      BigInteger _l2TxNumberInBlock,
  ...
  public RemoteFunctionCall<Boolean> proveL2LogInclusion(
      BigInteger _blockNumber, BigInteger _index, L2Log _log, List<byte[]> _proof) {
    final Function function =
        new Function(
            FUNC_PROVEL2LOGINCLUSION,
            Arrays.<Type>asList(
                ...
                new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.generated.Bytes32>(
                    org.web3j.abi.datatypes.generated.Bytes32.class,
                    org.web3j.abi.Utils.typeMap(
                        _proof, org.web3j.abi.datatypes.generated.Bytes32.class))),
            Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
    return executeRemoteCallSingleValueReturn(function, Boolean.class);
  }

  public RemoteFunctionCall<Boolean> proveL2MessageInclusion(
      BigInteger _blockNumber, BigInteger _index, L2Message _message, List<byte[]> _proof) {
    final Function function =
        new Function(
  ...
  public RemoteFunctionCall<TransactionReceipt> requestL2Transaction(
      String _contractL2,
      BigInteger _l2Value,
      byte[] _calldata,
      BigInteger _l2GasLimit,
      BigInteger _l2GasPerPubdataByteLimit,
      List<byte[]> _factoryDeps,
      String _refundRecipient,
      BigInteger weiValue) {
    final Function function =
        new Function(
            FUNC_REQUESTL2TRANSACTION,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.Address(_contractL2),
                ...
                new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.DynamicBytes>(
                    ...
                    org.web3j.abi.Utils.typeMap(
                        _factoryDeps, org.web3j.abi.datatypes.DynamicBytes.class)),
  ...
  public RemoteFunctionCall<TransactionReceipt> securityCouncilUpgradeApprove(
      byte[] _upgradeProposalHash) {
    final Function function =
        new Function(
            FUNC_SECURITYCOUNCILUPGRADEAPPROVE,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.generated.Bytes32(_upgradeProposalHash)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }

  public RemoteFunctionCall<L2CanonicalTransaction> serializeL2Transaction(
      BigInteger _txId,
      BigInteger _l2Value,
      String _sender,
      String _contractAddressL2,
      byte[] _calldata,
      BigInteger _l2GasLimit,
      BigInteger _l2GasPerPubdataByteLimit,
      List<byte[]> _factoryDeps,
    ...
    final Function function =
        new Function(
            FUNC_SERIALIZEL2TRANSACTION,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.generated.Uint256(_txId),
                new org.web3j.abi.datatypes.generated.Uint256(_l2Value),
  ...
  public RemoteFunctionCall<TransactionReceipt> setL2BootloaderBytecodeHash(
      byte[] _l2BootloaderBytecodeHash) {
    final Function function =
        new Function(
            FUNC_SETL2BOOTLOADERBYTECODEHASH,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.generated.Bytes32(_l2BootloaderBytecodeHash)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }

  public RemoteFunctionCall<TransactionReceipt> setL2DefaultAccountBytecodeHash(
      byte[] _l2DefaultAccountBytecodeHash) {
    final Function function =
        new Function(
            FUNC_SETL2DEFAULTACCOUNTBYTECODEHASH,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.generated.Bytes32(_l2DefaultAccountBytecodeHash)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }
  ...
  public RemoteFunctionCall<TransactionReceipt> setPorterAvailability(
      Boolean _zkPorterIsAvailable) {
    final Function function =
        new Function(
  ...
  public RemoteFunctionCall<TransactionReceipt> setPriorityTxMaxGasLimit(
      BigInteger _newPriorityTxMaxGasLimit) {
    final Function function =
        new Function(
            FUNC_SETPRIORITYTXMAXGASLIMIT,
            Arrays.<Type>asList(
                new org.web3j.abi.datatypes.generated.Uint256(_newPriorityTxMaxGasLimit)),
            Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }
  ...
  public RemoteFunctionCall<TransactionReceipt> setVerifierParams(
      VerifierParams _newVerifierParams) {
    final Function function =
        new Function(
  ...
  public RemoteFunctionCall<TransactionReceipt> unfreezeDiamond() {
    final Function function =
        new Function(
            FUNC_UNFREEZEDIAMOND, Arrays.<Type>asList(), Collections.<TypeReference<?>>emptyList());
    return executeRemoteCallTransaction(function);
  }

  public RemoteFunctionCall<byte[]> upgradeProposalHash(
      DiamondCutData _diamondCut, BigInteger _proposalId, byte[] _salt) {
    final Function function =
        new Function(
  ...
  @Deprecated
  public static ZkSyncContract load(
      String contractAddress,
      Web3j web3j,
      Credentials credentials,
      BigInteger gasPrice,
  ...
  public static RemoteCall<ZkSyncContract> deploy(
      Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
    return deployRemoteCall(
        ZkSyncContract.class, web3j, credentials, contractGasProvider, BINARY, "");
  }
  ...
  public static RemoteCall<ZkSyncContract> deploy(
    ...
    return deployRemoteCall(
        ZkSyncContract.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
  }

  public static RemoteCall<ZkSyncContract> deploy(
      Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    return deployRemoteCall(
        ZkSyncContract.class, web3j, transactionManager, contractGasProvider, BINARY, "");
  }
  ...
  public static RemoteCall<ZkSyncContract> deploy(
      ...
      BigInteger gasLimit) {
    return deployRemoteCall(
        ZkSyncContract.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
  }
  ...
  public static class L2CanonicalTransaction extends DynamicStruct {
    ...
    public L2CanonicalTransaction(
        BigInteger txType,
        BigInteger from,
        BigInteger to,
        BigInteger gasLimit,
        BigInteger gasPerPubdataByteLimit,
        BigInteger maxFeePerGas,
        BigInteger maxPriorityFeePerGas,
        BigInteger paymaster,
        BigInteger nonce,
        BigInteger value,
        List<BigInteger> reserved,
        byte[] data,
        byte[] signature,
        List<BigInteger> factoryDeps,
        byte[] paymasterInput,
        byte[] reservedDynamic) {
      super(
          new org.web3j.abi.datatypes.generated.Uint256(txType),
          ...
          new org.web3j.abi.datatypes.generated.StaticArray4<
              org.web3j.abi.datatypes.generated.Uint256>(
              org.web3j.abi.datatypes.generated.Uint256.class,
              org.web3j.abi.Utils.typeMap(
                  reserved, org.web3j.abi.datatypes.generated.Uint256.class)),
          new org.web3j.abi.datatypes.DynamicBytes(data),
          new org.web3j.abi.datatypes.DynamicBytes(signature),
          new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.generated.Uint256>(
              org.web3j.abi.datatypes.generated.Uint256.class,
              org.web3j.abi.Utils.typeMap(
                  factoryDeps, org.web3j.abi.datatypes.generated.Uint256.class)),
    ...
    public L2CanonicalTransaction(
        ...
        Uint256 nonce,
        Uint256 value,
        StaticArray4<Uint256> reserved,
        DynamicBytes data,
        DynamicBytes signature,
        DynamicArray<Uint256> factoryDeps,
        DynamicBytes paymasterInput,
        DynamicBytes reservedDynamic) {
      super(
          txType,
          from,
          to,
      ...
      this.reserved =
          reserved.getValue().stream().map(v -> v.getValue()).collect(Collectors.toList());
      this.data = data.getValue();
      this.signature = signature.getValue();
      this.factoryDeps =
          factoryDeps.getValue().stream().map(v -> v.getValue()).collect(Collectors.toList());
  ...
  public static class VerifierParams extends StaticStruct {
    ...
    public VerifierParams(
        byte[] recursionNodeLevelVkHash,
        byte[] recursionLeafLevelVkHash,
        byte[] recursionCircuitsSetVksHash) {
      super(
          new org.web3j.abi.datatypes.generated.Bytes32(recursionNodeLevelVkHash),
  ...
  public static class FacetCut extends DynamicStruct {
    ...
    public FacetCut(String facet, BigInteger action, Boolean isFreezable, List<byte[]> selectors) {
      super(
          new org.web3j.abi.datatypes.Address(facet),
          ...
          new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.generated.Bytes4>(
              ...
              org.web3j.abi.Utils.typeMap(
                  selectors, org.web3j.abi.datatypes.generated.Bytes4.class)));
      this.facet = facet;
      this.action = action;
    ...
    public FacetCut(Address facet, Uint8 action, Bool isFreezable, DynamicArray<Bytes4> selectors) {
      ...
      this.selectors =
          selectors.getValue().stream().map(v -> v.getValue()).collect(Collectors.toList());
    }
  }
  ...
  public static class StoredBlockInfo extends StaticStruct {
    ...
    public StoredBlockInfo(
        BigInteger blockNumber,
        byte[] blockHash,
        BigInteger indexRepeatedStorageChanges,
        BigInteger numberOfLayer1Txs,
        byte[] priorityOperationsHash,
        byte[] l2LogsTreeRoot,
        BigInteger timestamp,
        byte[] commitment) {
      super(
          new org.web3j.abi.datatypes.generated.Uint64(blockNumber),
  ...
  public static class CommitBlockInfo extends DynamicStruct {
    ...
    public CommitBlockInfo(
        ...
        byte[] l2LogsTreeRoot,
        byte[] priorityOperationsHash,
        byte[] initialStorageChanges,
        byte[] repeatedStorageChanges,
        byte[] l2Logs,
        List<byte[]> l2ArbitraryLengthMessages,
        List<byte[]> factoryDeps) {
      super(
          new org.web3j.abi.datatypes.generated.Uint64(blockNumber),
          ...
          new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.DynamicBytes>(
              org.web3j.abi.datatypes.DynamicBytes.class,
              org.web3j.abi.Utils.typeMap(
                  l2ArbitraryLengthMessages, org.web3j.abi.datatypes.DynamicBytes.class)),
          new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.DynamicBytes>(
              org.web3j.abi.datatypes.DynamicBytes.class,
              org.web3j.abi.Utils.typeMap(
                  factoryDeps, org.web3j.abi.datatypes.DynamicBytes.class)));
      this.blockNumber = blockNumber;
      this.timestamp = timestamp;
      this.indexRepeatedStorageChanges = indexRepeatedStorageChanges;
    ...
    public CommitBlockInfo(
        ...
        Bytes32 l2LogsTreeRoot,
        Bytes32 priorityOperationsHash,
        DynamicBytes initialStorageChanges,
        DynamicBytes repeatedStorageChanges,
        DynamicBytes l2Logs,
        DynamicArray<DynamicBytes> l2ArbitraryLengthMessages,
        DynamicArray<DynamicBytes> factoryDeps) {
      super(
          blockNumber,
          timestamp,
          indexRepeatedStorageChanges,
      ...
      this.l2ArbitraryLengthMessages =
          l2ArbitraryLengthMessages.getValue().stream()
              .map(v -> v.getValue())
  ...
  public static class PriorityOperation extends StaticStruct {
    ...
    public PriorityOperation(
        byte[] canonicalTxHash, BigInteger expirationTimestamp, BigInteger layer2Tip) {
      super(
          new org.web3j.abi.datatypes.generated.Bytes32(canonicalTxHash),
    ...
    public PriorityOperation(
        Bytes32 canonicalTxHash, Uint64 expirationTimestamp, Uint192 layer2Tip) {
  ...
  public static class ProofInput extends DynamicStruct {
    ...
    public ProofInput(
        List<BigInteger> recursiveAggregationInput, List<BigInteger> serializedProof) {
      super(
          new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.generated.Uint256>(
              org.web3j.abi.datatypes.generated.Uint256.class,
              org.web3j.abi.Utils.typeMap(
                  recursiveAggregationInput, org.web3j.abi.datatypes.generated.Uint256.class)),
          new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.generated.Uint256>(
              org.web3j.abi.datatypes.generated.Uint256.class,
              org.web3j.abi.Utils.typeMap(
                  serializedProof, org.web3j.abi.datatypes.generated.Uint256.class)));
      this.recursiveAggregationInput = recursiveAggregationInput;
      this.serializedProof = serializedProof;
    }

    public ProofInput(
        DynamicArray<Uint256> recursiveAggregationInput, DynamicArray<Uint256> serializedProof) {
      super(recursiveAggregationInput, serializedProof);
      this.recursiveAggregationInput =
          recursiveAggregationInput.getValue().stream()
              .map(v -> v.getValue())
              .collect(Collectors.toList());
      this.serializedProof =
          serializedProof.getValue().stream().map(v -> v.getValue()).collect(Collectors.toList());
    }
  }
  ...
  public static class L2Log extends StaticStruct {
    ...
    public L2Log(
        BigInteger l2ShardId,
        Boolean isService,
        BigInteger txNumberInBlock,
        String sender,
        byte[] key,
        byte[] value) {
      super(
          new org.web3j.abi.datatypes.generated.Uint8(l2ShardId),
  ...
  public static class DiamondCutData extends DynamicStruct {
    ...
    public DiamondCutData(List<FacetCut> facetCuts, String initAddress, byte[] initCalldata) {
      super(
          new org.web3j.abi.datatypes.DynamicArray<FacetCut>(FacetCut.class, facetCuts),
    ...
    public DiamondCutData(
        @Parameterized(type = FacetCut.class) DynamicArray<FacetCut> facetCuts,
        Address initAddress,
        DynamicBytes initCalldata) {
