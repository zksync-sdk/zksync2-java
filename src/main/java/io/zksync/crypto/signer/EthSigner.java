...
public interface EthSigner {
   ...
   */
  <S extends Structurable> CompletableFuture<String> signTypedData(
   ...
   */
  <S extends Structurable> CompletableFuture<Boolean> verifyTypedData(
   ...
   *
   * @param message - Message to sign
   * @param addPrefix - If true then add secure prefix (<a
   *     href="https://eips.ethereum.org/EIPS/eip-712">EIP-712</a>)
   * @return Signature object
   */
   ...
   * @param signature - Signature object
   * @param message - Message to verify
   * @param prefixed - If true then add secure prefix (<a
   *     href="https://eips.ethereum.org/EIPS/eip-712">EIP-712</a>)
   * @return true on verification success
   */
