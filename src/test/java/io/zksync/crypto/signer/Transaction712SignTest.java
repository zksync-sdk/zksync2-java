...
public class Transaction712SignTest {
  ...
  public void testSignTypedTransferData() {
    ...
    assertEquals(
        "0x4a9ff9c2a31be0ef25954a4906865953edab960ed7f509a00c86db9f70df01a904f73dbac053f119f6d90878f95c5da1f666e1dc987355fa666e82d50a56cdce1b",
        signature);
  }
  ...
  public void testSignTypedExecuteData() {
    ...
    final String signature = key.signTypedData(domain, message).join();
    assertEquals(
        "0x07c9e373dba52a79d4c5d539aa73ad6f3dcd362702788fa5177f045af6f63ef638f04c295e9469249cb960146d3d9d101a13a5d1e6795f439a3cf6f222200a761b",
        signature);
  }
  ...
  private static Transaction712 buildTransferTransaction() {
    return new Transaction712(
        ...
        new Eip712Meta(Numeric.toBigInt("0x3d0e"), null, null, new PaymasterParams()));
  }
  ...
  private static Transaction712 buildExecuteTransaction() {
    return new Transaction712(
        ...
        Numeric.toBigInt("0xee6b280"),
        "0x7e5f4552091a69125d5dfcb7b8c2659029395bdf",
        new Eip712Meta(Numeric.toBigInt("0x4e20"), null, null, new PaymasterParams()));
  }
}
