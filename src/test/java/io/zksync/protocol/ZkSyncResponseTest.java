...
public class ZkSyncResponseTest extends ResponseTester {
    ...
    void zksGetBlock() {
        ...
        Assertions.assertEquals(Numeric.decodeQuantity("0x730"), zksBlock.getResult().getL1BatchNumber());
        Assertions.assertEquals(Numeric.decodeQuantity("0x63eb7ae0"), zksBlock.getResult().getL1BatchTimestamp());
        Assertions.assertEquals(Numeric.decodeQuantity("0x1dcd6500"), zksBlock.getResult().getBaseFeePerGas());
        Assertions.assertEquals("0xe47fa912bd7a769abb076cdf222e4fb643353b3cf4fccbe7b1562ace98bd9b29", zksBlock.getResult().getParentHash());
