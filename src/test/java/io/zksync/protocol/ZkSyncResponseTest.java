...
public class ZkSyncResponseTest extends ResponseTester {
  ...
  void zksEstimateFee() {
    buildResponse(
        "{\"jsonrpc\":\"2.0\",\"result\":{\"gas_limit\":\"0x4be68\",\"gas_per_pubdata_limit\":\"0x27100\",\"max_fee_per_erg\":\"0x5f5e100\",\"max_priority_fee_per_erg\":\"0x5f5e100\"},\"id\":1}");
  ...
  void zksMainContract() {
    buildResponse(
        "{\"jsonrpc\":\"2.0\",\"result\":\"0xdbf3be149a9d1aa76870f44670e9db4cfe041766\",\"id\":1}");

    ZksMainContract zksMainContract = deserialiseResponse(ZksMainContract.class);

    Assertions.assertEquals(
        "0xdbf3be149a9d1aa76870f44670e9db4cfe041766", zksMainContract.getResult());
  }

  @Test
  void zksGetConfirmedTokens() {
    buildResponse(
        "{\"jsonrpc\":\"2.0\",\"result\":[{\"decimals\":18,\"l1Address\":\"0x0000000000000000000000000000000000000000\",\"l2Address\":\"0x0000000000000000000000000000000000000000\",\"name\":\"Ether\",\"symbol\":\"ETH\"}],\"id\":1}");
  ...
  void zksGetAllAccountBalances() {
    buildResponse(
        "{\"jsonrpc\":\"2.0\",\"result\":{\"0x0000000000000000000000000000000000000000\":\"0xa6886f73b1e\"},\"id\":1}");
  ...
  void zksGetBridgeContracts() {
    buildResponse(
        "{\"jsonrpc\":\"2.0\",\"result\":{\"l1Erc20DefaultBridge\":\"0x3f92815bec299f152eafa1dc9b1290b307b91cfb\",\"l2Erc20DefaultBridge\":\"0x39971d3297eb5b99d2f1f3ee42a5abecce0b751c\"},\"id\":1}");

    ZksBridgeAddresses zksBridgeAddresses = deserialiseResponse(ZksBridgeAddresses.class);

    Assertions.assertEquals(
        "0x3f92815bec299f152eafa1dc9b1290b307b91cfb",
        zksBridgeAddresses.getResult().getL1Erc20DefaultBridge());
    Assertions.assertEquals(
        "0x39971d3297eb5b99d2f1f3ee42a5abecce0b751c",
        zksBridgeAddresses.getResult().getL2Erc20DefaultBridge());
  }
