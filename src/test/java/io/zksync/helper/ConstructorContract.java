...
public class ConstructorContract extends Contract {
  ...
  static {
    try (FileInputStream fis =
        new FileInputStream("src/test/resources/constructorContractBinary.hex")) {
  ...
  @Deprecated
  public static ConstructorContract load(
      String contractAddress,
      Web3j web3j,
      Credentials credentials,
      BigInteger gasPrice,
  ...
  public static RemoteCall<ConstructorContract> deploy(
      Web3j web3j,
      Credentials credentials,
      ContractGasProvider contractGasProvider,
      BigInteger a,
