...
public class BaseIntegrationEnv {
  ...
  protected void deposit() throws IOException {
    ...
    ContractGasProvider gasProvider =
        new StaticGasProvider(
            Convert.toWei("1", Convert.Unit.GWEI).toBigInteger(), BigInteger.valueOf(555_000L));
  ...
  protected TransactionReceipt submitTransaction(io.zksync.methods.request.Transaction estimate)
